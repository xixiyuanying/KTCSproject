...
<?PHP
    ...
    //echo "ReservationNum is: $ReservationNum";
    echo "
	<section id='portfolio'>
			<div class='container'>
				<div class='row'>
					<div class='col-lg-12 text-center'>
						<h2>Record The Drop Off Information</h2>
						<hr class='star-primary'>
					</div>
				</div>
    <form name = 'Dropoff' action = 'dropoff.php' method='POST' enctype='multipart/form-data'>

    <input type='hidden' value=$ReservationNum name='passReservationNum' />

    <P> Record your drop-off date: <input type='date' name='dropoffdate'> </P>
